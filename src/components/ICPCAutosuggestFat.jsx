...
export default class ICPCAutosuggestFat extends React.Component {
  constructor() {
    super();
    this.state = {
      showSpinner: false,
  ...
  renderSuggestion = (suggestion) =>
    suggestion.code && suggestion.name_norwegian ? (
      <>
        ...
        {"ICPC-2: "}
        <a
          href={"codeView?codeSystem=icpc2&code=" + suggestion.code}
  ...
  onSuggestionsFetchRequested = ({ value }) => {
    ...
    let body =
      '{"query": "' + query + '","filters" : {"code_system": [ "ICPC-2" ]}}';
    console.log("url:", url);
