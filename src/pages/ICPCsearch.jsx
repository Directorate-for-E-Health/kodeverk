...
export const ICPCsearch = class ICPCsearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showSpinner: false,
      ...
      <div className="App">
        ...
        <article>
          <ul className="breadCrum breadCrum">
            ...
            <li className="inline breadCrum"> ICPC-2</li>
          </ul>
        </article>
        <article>
          <div className="row justify-content-md-center">
            <div className="col-9">
              <ICPCAutosuggest
                ...
                placeholder="Søk med term eller kode i ICPC-2-kodeverket"
              />
            </div>
          </div>
        </article>
